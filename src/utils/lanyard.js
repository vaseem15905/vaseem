...
// export default function Lanyard({ position = [0, 0, 80], gravity = [0, -40, 0], fov = 0, transparent = true }) {
//   return (
...
//   return (
//     <>
//       {/* Move X from 0 to 1 to shift right */}
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  return (
    <>
      {/* X value set to 1 for slight right shift */}
